...
export const cases: CaseStudy[] = [
  {
    ...
    metrics: [
      { val: "Fill in", label: "ROAS (Meta)" },
      { val: "Fill in", label: "CVR improvement" },
      { val: "Fill in", label: "Revenue growth" },
      { val: "Fill in", label: "Cost per purchase" },
    ],
  ...
  },
  {
    ...
    metrics: [
      ...
      { val: "Fill in", label: "Cart recovery rate" },
      { val: "Fill in", label: "RTO reduction" },
  ...
  },
  {
    ...
    metrics: [
      { val: "Fill in", label: "ROAS" },
      { val: "Fill in", label: "Brand search growth" },
      { val: "Fill in", label: "Influencer-driven revenue" },
      { val: "Fill in", label: "CVR improvement" },
    ],
    ...
    fill: ["ROAS before & after", "Influencer-driven GMV", "Brand search volume growth", "Follower/reach growth", "Conversion rate before & after", "Repeat purchase rate"],
  },
  {
